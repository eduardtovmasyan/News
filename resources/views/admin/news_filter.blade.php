        ...
        <div class="btn-group" style="margin-right: 30px; ">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li value="{{ $type->id }}"><a href="/news/filter/{{ $type->id }}"  value="{{ $type->id }}">{{ $type->type }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="portlet-title">
                ...
                <div class="mt-author" style="float: right;">
                    ...
                    <div class="mt-author-name">
                        <a href="javascript:;" class="font-blue-madison">{{ $post->creator->name }} {{ $post->creator->surname }}</a>
                    </div>
                </div>
            </div>
